...
func (c *entityServiceClient) GetEntity(ctx context.Context, in *EntityRequest, opts ...grpc.CallOption) (*Entity, error) {
	out := new(Entity)
...
func (UnimplementedEntityServiceServer) GetEntity(context.Context, *EntityRequest) (*Entity, error) {
...
func _EntityService_GetEntity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EntityServiceServer).GetEntity(ctx, req.(*EntityRequest))
	}
